...
(autoload 'ellama-session-compact-current "ellama" "\
Compact current Ellama session context." t)
(autoload 'ellama-session-compact "ellama" "\
Select and compact an active Ellama session context." t)
...
(fn PROBLEM)" t)
(autoload 'ellama-ask-image "ellama" "\
Ask ellama PROMPT about IMAGE using ephemeral context.
If CREATE-SESSION set, create a new session.

(fn IMAGE PROMPT &optional CREATE-SESSION &rest ARGS)" t)
(autoload 'ellama-chat-with-image "ellama" "\
Send PROMPT with IMAGE to ellama chat.
If CREATE-SESSION set, create a new session.

(fn IMAGE PROMPT &optional CREATE-SESSION &rest ARGS)" t)
(autoload 'ellama-chat-with-images "ellama" "\
Send PROMPT with IMAGES to ellama chat.
If CREATE-SESSION set, create a new session.

(fn IMAGES PROMPT &optional CREATE-SESSION &rest ARGS)" t)
...
(autoload 'ellama-context-add-image-file "ellama-context" "\
Add image FILE-NAME to context.
For one request only if EPHEMERAL.

(fn FILE-NAME &optional EPHEMERAL)")
(autoload 'ellama-context-add-image "ellama-context" "\
...
(register-definition-prefixes "ellama-manual" '("ellama-manual--readme-content"))
...

;;; Generated autoloads from ellama-tools-dlp.el

(register-definition-prefixes "ellama-tools-dlp" '("ellama-tools-"))


;;; Generated autoloads from ellama-transient.el

 (autoload 'ellama-select-model "ellama-transient" nil t)
